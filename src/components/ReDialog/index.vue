...
import { isFunc } from "@masonjs/utils";
      ...
      : ([
          {
            ...
            btnClick: ({ dialog: { options, index } }) => {
              ...
              if (options?.beforeCancel && isFunc(options?.beforeCancel)) {
          ...
          },
          {
            ...
            btnClick: ({ dialog: { options, index } }) => {
              ...
              if (options?.beforeSure && isFunc(options?.beforeSure)) {
...
function eventsCallBack(
  ...
  if (options?.[event] && isFunc(options?.[event])) {
